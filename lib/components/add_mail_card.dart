...
class AddMailCard extends StatelessWidget {
  final VoidCallback onExit;

  const AddMailCard({super.key, required this.onExit});
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Row(
                // mainAxisAlignment: MainAxisAlignment.center, // 标题内容通常左对齐或根据设计
                children: [
            ...
            // 原有内容
            Expanded( // 使内容区域填充剩余空间，并将按钮推到底部（如果需要）
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center, // 居中提示文本
                children: [
                  Text( // 移除了 const
                    '“添加邮箱”卡片组件创建成功！',
            ...
            const SizedBox(height: 24), // 内容与退出按钮的间距
            ElevatedButton.icon(
